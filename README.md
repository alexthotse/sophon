<h1 align="center">
 <a href="https://sophon.ai">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/sophon-logo-dark-v2.png"/>
    <source media="(prefers-color-scheme: light)" srcset="images/sophon-logo-light-v2.png"/>
    <img width="400" src="images/sophon-logo-dark-bg-v2.png"/>
 </a>
 <br />
</h1>
<br />
...
<p align="center">
  ...
  <a href="#examples-">
   ...
   ·
  <a href="https://docs.sophon.ai/hosting/self-hosting/local-mode-quickstart">
...
<div align="center">
<a href="https://trendshift.io/repositories/8994" target="_blank"><img src="https://trendshift.io/api/badge/repositories/8994" alt="sophon-ai%2Fsophon | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>
...
<div align="center">
  <a href="https://www.youtube.com/watch?v=SFSu2vNmlLk">
    <img src="images/sophon-v2-yt.png" alt="Sophon v2 Demo Video" width="800">
  </a>
</div>

<br/>

💻  Sophon is a terminal-based AI development tool that can **plan and execute** large coding tasks that span many steps and touch dozens of files. It can handle up to 2M tokens of context directly (~100k per file), and can index directories with 20M tokens or more using tree-sitter project maps.

🔬  **A cumulative diff review sandbox** keeps AI-generated changes separate from your project files until they are ready to go. Command execution is controlled so you can easily roll back and debug. Sophon helps you get the most out of AI without leaving behind a mess in your project.
...
🚀  Sophon is capable of <strong>full autonomy</strong>—it can load relevant files, plan and implement changes, execute commands, and automatically debug—but it's also highly flexible and configurable, giving developers fine-grained control and a step-by-step review process when needed.

💪  Sophon is designed to be resilient to <strong>large projects and files</strong>. If you've found that others tools struggle once your project gets past a certain size or the changes are too complex, give Sophon a shot.

## Smart context management that works in big projects

- 🐘 **2M token effective context window** with default model pack. Sophon loads only what's needed for each step.
...
- 🛡️ **Reliable file edits** that prioritize correctness. While most edits are quick and cheap, Sophon validates both syntax and logic as needed, with multiple fallback layers when there are problems.
...
- 🧑‍💻 **REPL mode** with fuzzy auto-complete for commands and file loading. Just run `sophon` in any project to get started.
...
<img src="images/sophon-workflow.png" alt="Sophon workflow" width="100%"/>
...
<div align="center">
  <a href="https://www.youtube.com/watch?v=g-_76U_nK0Y">
    <img src="images/sophon-browser-debug-yt.png" alt="Sophon Browser Debugging Example" width="800">
  </a>
</div>
...
**Note:** Windows is supported via [WSL](https://learn.microsoft.com/en-us/windows/wsl/install). Sophon only works correctly on Windows in the WSL shell. It doesn't work in the Windows CMD prompt or PowerShell.

[More installation options.](https://docs.sophon.ai/install)
...
<!-- If you're going with a 'BYO API Key' option above (whether cloud or self-hosted), you'll need to set API keys for the [model providers](https://docs.sophon.ai/models/model-providers) you're using: -->
...
If you have a Claude Pro or Max subscription, Sophon can use it when calling Anthropic models. You'll be asked if you want to connect a subscription the first time you run Sophon.
...
For a new project, you might also want to initialize a git repo. Sophon doesn't require that your project is in a git repo, but it does integrate well with git if you use it.

```bash
git init
```

Now start the Sophon REPL in your project:
...
### [👉  Full documentation.](https://docs.sophon.ai/)
...
- [Follow @SophonAI](https://x.com/SophonAI)
- [Follow @Danenania](https://x.com/Danenania) (Sophon's creator)
- [Subscribe on YouTube](https://x.com/SophonAI)

<br/>

## Contributors  👥

⭐️  Please star, fork, explore, and contribute to Sophon. There's a lot of work to do and so much that can be improved.

[Here's an overview on setting up a development environment.](https://docs.sophon.ai/development)
