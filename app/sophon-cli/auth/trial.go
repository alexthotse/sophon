...
func ConvertTrial() {
	openAuthenticatedURL("Opening Sophon Cloud upgrade flow in your browser.", "/settings/billing?upgrade=1&cliUpgrade=1")
	...
	term.StopSpinner()
	term.OutputErrorAndExit("Timed out waiting for upgrade. Please try again. Email support@sophon.ai if the problem persists.")
}
...
func startTrial() {
	...
	openUnauthenticatedCloudURL(
		"Opening Sophon Cloud trial flow in your browser.",
	...
	term.StopSpinner()
	term.OutputErrorAndExit("Timed out waiting for trial to start. Please try again. Email support@sophon.ai if the problem persists.")
}
