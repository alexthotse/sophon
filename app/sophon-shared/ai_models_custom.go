...
const (
	SchemaUrlInputConfig     SchemaUrl = "https://sophon.ai/schemas/models-input.schema.json"
	SchemaUrlPlanConfig      SchemaUrl = "https://sophon.ai/schemas/plan-config.schema.json"
	SchemaUrlInlineModelPack SchemaUrl = "https://sophon.ai/schemas/model-pack-inline.schema.json"
)
