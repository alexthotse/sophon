...
replace sophon-server => ../../../

replace sophon-shared => ../../../../shared

replace sophon-cli => ../../../../cli

require (
	sophon-cli v0.0.0-00010101000000-000000000000
	sophon-server v0.0.0-00010101000000-000000000000
	sophon-shared v0.0.0-00010101000000-000000000000
)
