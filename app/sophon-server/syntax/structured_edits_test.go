			...
			original: `
{
  "name": "vscode-sophon",
  "displayName": "Sophon",
  "description": "VSCode extension for Sophon integration",
  "version": "0.1.0",
  "engines": {
    "vscode": "^1.80.0"
  },
  ...
  "contributes": {
    ...
    "keybindings": [{
      ...
      "key": "@",
      "when": "editorTextFocus && editorLangId == sophon"
    }]
  },
  "scripts": {
			...
			proposed: `
{
  ...
  "contributes": {
    "languages": [{
      ...
      "icon": {
          "light": "./icons/sophon-light.png",
          "dark": "./icons/sophon-dark.png"
      }
    }],
    "grammars": [{
      "language": "sophon",
      "scopeName": "text.sophon",
      "path": "./syntaxes/sophon.tmLanguage.json",
      "embeddedLanguages": {
    ...
    "keybindings": [
      {
        "command": "sophon.showFilePicker",
        "key": "@",
        "when": "editorTextFocus && editorLangId == sdx"
      }
    ],
    "menus": {
      "editor/title": [
