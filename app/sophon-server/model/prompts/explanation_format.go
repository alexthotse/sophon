...
- sound.py:
<SophonBlock lang="python" path="sound.py">
# ... existing code ...
...
<SophonBlock lang="go" path="server/handlers/auth.go">
// ... existing code ...
...
<SophonBlock lang="go" path="server/models/user.go">
package models
...
<SophonBlock lang="go" path="server/handlers/users.go">
package handlers
...
<SophonBlock lang="go" path="server/config/defaults.go">
package config
...
- server/api/auth.go:
<SophonBlock lang="go" path="server/api/auth.go">
package auth
