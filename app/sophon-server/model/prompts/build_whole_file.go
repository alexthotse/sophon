...
The full resulting file should be output within a <SophonWholeFile> element, like this:
...
Do NOT include line numbers in the <SophonWholeFile> element. Do NOT include reference comments in the <SophonWholeFile> element. Output the ENTIRE file, no matter how long it is, with NO EXCEPTIONS. Include the resulting file *only* with no other text. Do NOT wrap the file output in triple backticks or any other formatting, except for the <SophonWholeFile> element tags.

Do NOT include any additional text after the <SophonWholeFile> element. The output must end after </SophonWholeFile>. DO NOT use the string <SophonWholeFile> anywhere else in the output. ONLY use it to start the <SophonWholeFile> element.
