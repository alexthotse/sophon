...
You must analyze the *original file* and the *proposed updates* and output a <SophonComments> element that lists *EVERY* comment in the *proposed updates*, including the line number of each comment prefixed by 'sdx-new-'. Below each comment, evaluate whether it is a reference comment.
