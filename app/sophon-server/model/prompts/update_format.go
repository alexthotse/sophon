...
- example.js:
<SophonBlock lang="javascript" path="example.js">
// ... existing code ...
...
- config.json:
<SophonBlock lang="json" path="config.json">
{
  // ... existing code ...
...
- package.json:
<SophonBlock lang="json" path="package.json">
{                                                                         
  "name": "vscode-sophon",
  "contributes": {                                                        
    "languages": [{                                                       
    ...
    "commands": [
      {
        "command": "sophon.tellSophon",
      }
    ],
    "keybindings": [{
      "command": "sophon.showFilePicker",
    }]
  },
  "scripts": {
    "compile": "webpack",
...
- array.js:
<SophonBlock lang="javascript" path="array.js">
const a = [
  8,
  9,
  10,
...
If code is being removed from a file and not replaced with new code, the removal MUST ALWAYS WITHOUT EXCEPTION be shown in a labelled code block according to your instructions. Use the comment "// Sophon: removed code" (with the appropriate comment symbol for the programming language) to denote the removal. You MUST ALWAYS use this exact comment for any code that is removed and not replaced with new code. DO NOT USE ANY OTHER COMMENT FOR CODE REMOVAL.

'// Sophon: removed code' comments MUST *replace* the code that is being removed. The code that is being removed MUST NOT be included in the code block.
    
Do NOT use any other formatting apart from a labelled code block with the comment "// Sophon: removed code" to denote code removal.
...
- main.js:
<SophonBlock lang="javascript" path="main.js">
...
- src/main.go:
<SophonBlock lang="go" path="src/main.go">
// ... existing code ...
...
- src/config.json:
<SophonBlock lang="json" path="src/config.json">
{
  "database": {
    "host": "localhost",
    "port": 5432
