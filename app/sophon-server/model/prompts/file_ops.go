...
You ABSOLUTELY MUST end every file operation section with a <EndSophonFileOps/> tag.
...
- You MUST end the '### Move Files' section with a <EndSophonFileOps/> tag
...
- You MUST end the '### Remove Files' section with a <EndSophonFileOps/> tag
...
- Each path must be on its own line
- You MUST end the '### Reset Changes' section with a <EndSophonFileOps/> tag
...
3. Format Rules:
  ...
  - You MUST end each file operation section with a <EndSophonFileOps/> tag
