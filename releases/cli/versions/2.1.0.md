...
- If you started a free trial of Sophon with BYO Key mode, you can now switch to a trial of Integrated Models mode if desired from your [billing dashboard](https://app.sophon.ai/settings/billing) (use `\billing` from the REPL to open the dashboard).
