...
- Fix for "conversation summary timestamp not found in conversation" error (https://github.com/plandex-ai/sophon/issues/274)
- Fix for potential panic/crash during plan stream (https://github.com/plandex-ai/sophon/issues/275)
...
## Version 1.1.0
- Give notes added to context with `sophon load -n 'some note'` automatically generated names in `context ls` list.
...
- When hitting OpenAI rate limits, Sophon will now parse error messages that include a recommended wait time and automatically wait that long before retrying, up to 30 seconds (https://github.com/plandex-ai/sophon/issues/123)
...
- Fix for a potential panic during account creation (https://github.com/plandex-ai/sophon/issues/76)
- Fixes for some account creation flow issues (https://github.com/plandex-ai/sophon/issues/106)
- Fix for occasional "Stream buffer tokens too high" error (https://github.com/plandex-ai/sophon/issues/34).
- Fix for potential panic when updating model settings. Might possibly be the cause of or somehow related to https://github.com/plandex-ai/sophon/issues/121 but hard to be sure (maybe AWS was just being flakey).
...
- The [readme](https://github.com/plandex-ai/sophon) has been revamped to be more informative and easier to navigate.
...
- Sophon is less likely to screw up braces, parentheses, and other code structures.
- Sophon is less likely to mistakenly remove code that it shouldn't.
- Sophon is now much better at working through very long plans without skipping tasks, repeating tasks it's already done, or otherwise losing track of what it's doing.
- Server-side support for `sophon diff` command to show pending plan changes in `git diff` format.
- Server-side support for archiving and unarchiving plans.
- Server-side support for `sophon summary` command.
- Server-side support for `sophon rename` command.
...
- Handle file paths with ### prefixes (https://github.com/plandex-ai/sophon/issues/77)
- Fix for occasional race condition during file builds that causes error "Fatal: Unable to write new index file"

## Version 0.8.3
- SMTP_FROM environment variable for setting from address when self-hosting and using SMTP (https://github.com/plandex-ai/sophon/pull/39)
...
- Fix for unhelpful "Error getting plan, context, convo, or summaries" error message when OpenAI returns an error for invalid API key or insufficient credits (https://github.com/plandex-ai/sophon/issues/32)

## Version 0.8.2
- Fix for creating an org that auto-adds users based on email domain (https://github.com/plandex-ai/sophon/issues/24)
...
- Fix for server git user and email not being set in some environments (https://github.com/plandex-ai/sophon/issues/8)
...
- Backend support for `sophon invite`, `sophon users`, and `sophon revoke` commands
