...
- Fix for "conversation summary timestamp not found in conversation" error (https://github.com/sophon.ai/sophon/issues/274)
- Fix for potential panic/crash during plan stream (https://github.com/sophon.ai/sophon/issues/275)
...
- Fix for custom model creation (https://github.com/sophon.ai/sophon/issues/214)
- Fix for version check on self-hosted (https://github.com/sophon.ai/sophon/issues/213)
...
- When hitting OpenAI rate limits, Sophon will now parse error messages that include a recommended wait time and automatically wait that long before retrying, up to 30 seconds (https://github.com/sophon.ai/sophon/issues/123)
...
- Handle file paths with ### prefixes (https://github.com/sophon.ai/sophon/issues/77)
- Fix for occasional race condition during file builds that causes error "Fatal: Unable to write new index file"

## Version 0.8.3
- SMTP_FROM environment variable for setting from address when self-hosting and using SMTP (https://github.com/sophon.ai/sophon/pull/39)
...
- Fix for unhelpful "Error getting plan, context, convo, or summaries" error message when OpenAI returns an error for invalid API key or insufficient credits (https://github.com/sophon.ai/sophon/issues/32)

## Version 0.8.2
- Fix for creating an org that auto-adds users based on email domain (https://github.com/sophon.ai/sophon/issues/24)
...
- Fix for server git user and email not being set in some environments (https://github.com/sophon.ai/sophon/issues/8)
